...
impl Walker {
    ...
    fn classify_fork_segments_for_segment_with_context(
        ...
        self.with_fork_segments_for_segment_with_context(ctx, segment, |segments| match segments {
            [] => NextStepClass::None,
    ...
    fn move_to_roundabout_exit_with_context(
        ...
        loop {
            ...
            self.with_fork_segments_for_segment_with_context(ctx, &current_segment, |segments| {
                            ...
                            .with_roundabout_exits_for_segment_with_context(
                                ...
                                |available_segments| {
                                        ...
                                        && next_fork_choice_point.is_none()
                                    {
                                        return Ok((
                                            None,
                                            Some(SegmentList::from_iter(available_segments.iter())),
                                        ));
                                    }
                        ...
                        let (next_segment, fork_choices) = self
                            .with_fork_segments_for_segment_with_context(
                                ...
                                |available_segments| match (
                                    ...
                                    (segments, None) => {
                                        Ok((None, Some(SegmentList::from_iter(segments.iter()))))
                                    }
