...
run-lv-round:
	cargo run --release -- dual --input ./map-data/latvia-latest.osm.pbf --output map-data/lv.gpx --cache-dir ./map-data/cache/latvia round-trip --center {{gps-test-from-lat}},{{gps-test-from-lon}} --bearing 0 --distance 100
