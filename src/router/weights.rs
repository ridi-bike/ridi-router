...
pub struct WeightCalcHeading;

impl WeightCalc for WeightCalcHeading {
    fn name(&self) -> &'static str {
        "weight_heading"
    }
    fn rule_type(&self) -> &'static RuleType {
    ...
    fn calc(&self, input: WeightCalcInput) -> WeightCalcResult {
        ...
        let fork_bearing =
            if &fork_segment.get_line().borrow().points.1 == fork_segment.get_end_point() {
...
pub struct WeightCalcPreferSameRoad;

impl WeightCalc for WeightCalcPreferSameRoad {
    fn name(&self) -> &'static str {
...
pub struct WeightCalcNoLoops;

impl WeightCalc for WeightCalcNoLoops {
    fn name(&self) -> &'static str {
        "weight_no_loops"
    }
    fn rule_type(&self) -> &'static RuleType {
...
pub struct WeightCalcNoSharpTurns;

impl WeightCalc for WeightCalcNoSharpTurns {
    fn name(&self) -> &'static str {
...
pub struct WeightCalcNoShortDetour;

impl WeightCalc for WeightCalcNoShortDetour {
    fn name(&self) -> &'static str {
...
pub struct WeightCalcDistanceToNext;

impl WeightCalc for WeightCalcDistanceToNext {
    fn name(&self) -> &'static str {
...
pub struct WeightCalcProgressSpeed;

impl WeightCalc for WeightCalcProgressSpeed {
    fn name(&self) -> &'static str {
    ...
    fn calc(&self, input: WeightCalcInput) -> WeightCalcResult {
        ...
        let average_distance_per_segment =
            total_distance / (input.route.get_segment_count() as f32);
...
pub struct WeightCalcRulesHighway;

impl WeightCalc for WeightCalcRulesHighway {
    fn name(&self) -> &'static str {
...
pub struct WeightCalcRulesSurface;

impl WeightCalc for WeightCalcRulesSurface {
    fn name(&self) -> &'static str {
...
pub struct WeightCalcRulesSmoothness;

impl WeightCalc for WeightCalcRulesSmoothness {
    fn name(&self) -> &'static str {
...
mod test {
    ...
    use crate::{
        ...
        router::{
            ...
            rules::RouterRules, walker::Walker, weights::WeightCalcHeading,
        },
        test_utils::{graph_from_test_file, set_graph_static},
    };

    use super::{get_priority_from_headings, WeightCalc, WeightCalcInput};
    ...
    rusty_fork_test! {
        ...
        fn weight_heading_test() {
            ...
            let fork_weight = WeightCalcHeading.calc(WeightCalcInput {
